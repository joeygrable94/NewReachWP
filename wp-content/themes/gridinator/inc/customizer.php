 ...
 */
function wp_gridinator_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'wp_gridinator_customize_partial_blogname',
		) );
 ...
 * @return void
 */
function wp_gridinator_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 */
function wp_gridinator_customize_preview_js() {
